...
export default function AnalyticsIndex({
    ...
    const exportPdf = () => {
        setIsExporting(true);
        window.open(
            `/admin/analytics/export-pdf?date_from=${dateFrom}&date_to=${dateTo}`,
            "_blank",
        );
    ...
    const exportCsv = () => {
        window.open(
            `/admin/analytics/export-csv?date_from=${dateFrom}&date_to=${dateTo}`,
            "_blank",
        );
    };
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Track sales, customer behavior, and business
                            performance
                        </p>
                    </div>
