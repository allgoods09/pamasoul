...
export default function OrdersIndex({
    ...
    const handleBulkStatusUpdate = () => {
        ...
        if (
            confirm(
                `Update ${selectedOrders.length} order(s) to ${bulkStatus}?`,
            )
        ) {
            router.post(
                ...
                },
                {
                    onSuccess: () => {
                        toast.success(
                            `${selectedOrders.length} order(s) updated to ${bulkStatus}`,
                        );
                        setSelectedOrders([]);
                        setBulkStatus("");
                    },
    ...
    return (
        <AdminLayout>
            ...
            <div className="space-y-6">
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    {Icon && (
                                        <div
                                            className={`rounded-full p-3 ${statusColors[badge.value]?.bg}`}
                                        >
                                            <Icon
                                                className={`h-6 w-6 ${statusColors[badge.value]?.text}`}
                                            />
                                        </div>
                                    )}
                                </div>
                ...
                {/* Shipping Settings Card - NEW */}
                <ShippingSettingsCard shippingConfig={shippingConfig} />
                                            ...
                                            <td className="px-4 py-4 text-right">
                                                <div className="flex items-center justify-end space-x-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-gray-400 hover:text-gray-600"
                                                        title="Email customer order status"
                                                    >
