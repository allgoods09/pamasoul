...
export default function CustomerLayout({ children }) {
    ...
    const shippingConfig = props.shippingConfig || { free_threshold: 5000, base_fee: 50 };
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <header className="bg-white shadow-sm sticky top-0 z-50">
                ...
                <div className="bg-pamasoul text-gray-900 text-sm py-2">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-center">
                            ...
                            <p className="hidden sm:block">📞 Customer Support: (+63) 9389317261</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <Link href="/" className="flex items-center space-x-2">
                            <ApplicationLogo/>
                            <span className="text-xl font-bold text-gray-900 hidden sm:block">Pamasoul</span>
                            <span className="text-xs text-pamasoul hidden lg:block">Fishing Tackle</span>
                        </Link>
                    ...
                    <div className="fixed inset-y-0 right-0 z-50 w-64 bg-white shadow-lg">
                        ...
                        <nav className="p-4 space-y-3">
                            ...
                            <Link
                                ...
                                onClick={() => setMobileMenuOpen(false)}
                                className={`block py-2 text-base font-medium ${
                                    isShopActive() ? 'text-blue-600' : 'text-gray-700'
                                }`}
                            >
                                Shop
                            </Link>
                            <button
                                ...
                                className={`block w-full text-left py-2 text-base font-medium ${
                                    isCategoryActive(1) ? 'text-blue-600' : 'text-gray-700'
                                }`}
                            >
                                Rods
                            </button>
                            <button
                                ...
                                className={`block w-full text-left py-2 text-base font-medium ${
                                    isCategoryActive(2) ? 'text-blue-600' : 'text-gray-700'
                                }`}
                            >
                                Lines
                            </button>
                            <button
                                ...
                                className={`block w-full text-left py-2 text-base font-medium ${
                                    isCategoryActive(3) ? 'text-blue-600' : 'text-gray-700'
                                }`}
                            >
                                Reels
                            </button>
                            <div className="border-t pt-3 mt-3">
                                {user ? (
                                    <>
                                        <Link href="/my-orders" className="block py-2 text-gray-700" onClick={() => setMobileMenuOpen(false)}>
                                            My Orders
                                        </Link>
                                        <Link href="/profile" className="block py-2 text-gray-700" onClick={() => setMobileMenuOpen(false)}>
                                            Profile
                                        </Link>
                                        {user.role === 'admin' && (
                                            <Link href="/admin/dashboard" className="block py-2 text-blue-600" onClick={() => setMobileMenuOpen(false)}>
                                                Admin Panel
                                            </Link>
                                        )}
                                    ...
                                    <Link href="/login" className="block py-2 text-blue-600" onClick={() => setMobileMenuOpen(false)}>
                                        Login / Register
                                    </Link>
                                )}
                            </div>
            ...
            <main className="relative">
                ...
                <div className={`hidden xl:block absolute left-0 w-48 space-y-4 ${
                    currentPage === 'home' || currentPage === 'landing' ? 'top-[56vh]' : 
                    currentPage === 'shop' ? 'top-50' :
                    currentPage === 'product' ? 'top-50' :
                    currentPage === 'cart' ? 'top-50' :
                    currentPage === 'checkout' ? 'top-50' :
                    'top-32'
                }`}>
                    <AdBanner 
                        position="left" 
                        ...
                        adHeight="h-auto"  // Can be h-64, h-80, h-96, etc.
                    />
                </div>

                {/* Right Side Ad - Configurable positioning */}
                <div className={`hidden xl:block absolute right-0 w-48 space-y-4 ${
                    currentPage === 'home' || currentPage === 'landing' ? 'top-[56vh]' : 
                    currentPage === 'shop' ? 'top-50' :
                    currentPage === 'product' ? 'top-50' :
                    currentPage === 'cart' ? 'top-50' :
