        ...
        <div className="bg-white rounded-lg shadow">
            <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/admin/products?stock_status=low_stock" className="text-sm text-blue-600 hover:text-blue-800">
                        View all →
                    </Link>
                </div>
                ...
                {products.length > 0 ? (
                    <div className="space-y-4">
                        ...
                        {criticalStock.length > 0 && (
                            <div>
                                <p className="text-xs font-semibold text-red-600 uppercase mb-2">Critical (≤2 left)</p>
                                {criticalStock.map((product) => (
                                    <div key={product.id} className="flex items-center justify-between bg-red-50 p-3 rounded-lg mb-2">
                        ...
                        {warningStock.length > 0 && (
                            <div>
                                <p className="text-xs font-semibold text-yellow-600 uppercase mb-2">Warning (≤5 left)</p>
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-400 mt-1">No low stock items to display</p>
                    </div>
                )}
            </div>
        </div>
